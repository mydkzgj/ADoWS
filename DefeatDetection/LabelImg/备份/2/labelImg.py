...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None , transFilePath=""):
        ...
        close = action(closename, self.closeFile, 'Ctrl+W', 'close', u'Close current file')

        resetAll = action(resetAllname, self.resetAll, None, 'resetall', u'Reset all')
        ...
        help = action(helpname, self.showTutorialDialog, None, 'help', u'Show demos')
        showInfo = action(showInfoname, self.showInfoDialog, None, 'help', u'Information')
...
# CJY 2018.12.04 增加参数argv2
def get_main_app(argv=[],argv2=[]):   
    """
...
def main(argv = [] , argv2 = []):
    ...
    app, _win = get_main_app(argv,argv2)
    return app.exec_()
